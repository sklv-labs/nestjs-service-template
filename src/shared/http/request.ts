...
/**
 * Builders for the four parts of a request.
 *
 ...
 */
export const body = <T extends z.ZodRawShape>(shape: T) => z.object(shape).strict();
export const query = <T extends z.ZodRawShape>(shape: T) => z.object(shape);
export const params = <T extends z.ZodRawShape>(shape: T) => z.object(shape);
export const headers = <T extends z.ZodRawShape>(shape: T) => z.object(shape);
